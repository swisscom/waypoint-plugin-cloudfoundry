...
require (
	...
	github.com/hashicorp/waypoint v0.8.1
...
require (
	...
	code.cloudfoundry.org/go-log-cache v1.0.1-0.20200722221510-3f87d731aaa9 // indirect
	code.cloudfoundry.org/go-loggregator/v8 v8.0.2-0.20200722201844-b5130958b65d // indirect
